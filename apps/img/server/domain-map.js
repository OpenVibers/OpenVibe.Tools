...
const DOMAIN_MAP = {
    ...
    'img.openvibe.tools': {
        ...
        faIcon: 'fa-images',
        seoTitle: 'Img.OpenVibe — Online Image Converter & Tools',
        seoDescription: 'Convert, compress, resize, and crop images online. Supports PNG, JPG, WebP, AVIF, HEIC, SVG, GIF, ICO, TIFF, BMP and more.',
    },
    ...
    'png.openvibe.tools': {
        ...
        seoTitle: 'OpenVibePNG — Convert Images to PNG Online',
        seoDescription: 'Convert JPG, WebP, AVIF, HEIC, GIF, BMP, TIFF and more to PNG format online. Fast, no sign-up required.',
    },
    'jpg.openvibe.tools': {
        toolId: 'jpg', brandName: 'OpenVibeJPG', defaultOp: 'convert', defaultFormat: 'jpg',
        faIcon: 'fa-file-image',
        seoTitle: 'OpenVibeJPG — Convert Images to JPG Online',
        seoDescription: 'Convert PNG, WebP, AVIF, HEIC, GIF, BMP, TIFF and more to JPG format online. Fast, no sign-up required.',
    },
    'jpeg.openvibe.tools': {
        toolId: 'jpg', brandName: 'OpenVibeJPG', defaultOp: 'convert', defaultFormat: 'jpg',
        faIcon: 'fa-file-image', alias: 'jpg.openvibe.tools',
        seoTitle: 'OpenVibeJPG — Convert Images to JPEG Online',
        seoDescription: 'Convert any image to JPEG format online. Fast, no sign-up required.',
    },
    'webp.openvibe.tools': {
        toolId: 'webp', brandName: 'OpenVibeWebP', defaultOp: 'convert', defaultFormat: 'webp',
        faIcon: 'fa-file-image',
        seoTitle: 'OpenVibeWebP — Convert Images to WebP Online',
    ...
    'avif.openvibe.tools': {
        ...
        faIcon: 'fa-file-image',
        seoTitle: 'OpenVibeAVIF — Convert Images to AVIF Online',
    ...
    'heic.openvibe.tools': {
        ...
        faIcon: 'fa-file-image',
        seoTitle: 'OpenVibeHEIC — Convert HEIC/HEIF Images Online',
        seoDescription: 'Convert HEIC and HEIF photos from iPhone to PNG, JPG, WebP and more. Fast, works in your browser.',
    },
    'heif.openvibe.tools': {
        toolId: 'heic', brandName: 'OpenVibeHEIC', defaultOp: 'convert', defaultFormat: 'png',
        faIcon: 'fa-file-image', alias: 'heic.openvibe.tools',
        seoTitle: 'OpenVibeHEIC — Convert HEIF Images Online',
        seoDescription: 'Convert HEIF photos to PNG, JPG, WebP and more. Fast, works in your browser.',
    },
    'svg.openvibe.tools': {
        toolId: 'svg', brandName: 'OpenVibeSVG', defaultOp: 'convert', defaultFormat: 'png',
        faIcon: 'fa-bezier-curve',
        seoTitle: 'OpenVibeSVG — Convert SVG Images Online',
        seoDescription: 'Convert SVG to PNG, JPG, WebP. Convert bitmap images to SVG vector traces. Online SVG converter.',
    },
    'gif.openvibe.tools': {
        toolId: 'gif', brandName: 'OpenVibeGIF', defaultOp: 'convert', defaultFormat: 'gif',
        faIcon: 'fa-film',
        seoTitle: 'OpenVibeGIF — Convert Images to GIF Online',
        seoDescription: 'Convert images to and from GIF format online. Fast, no sign-up required.',
    },
    'ico.openvibe.tools': {
        toolId: 'ico', brandName: 'OpenVibeICO', defaultOp: 'convert', defaultFormat: 'ico',
        faIcon: 'fa-icons',
        seoTitle: 'OpenVibeICO — Create ICO Favicons Online',
    ...
    'tiff.openvibe.tools': {
        ...
        faIcon: 'fa-file-image',
        seoTitle: 'OpenVibeTIFF — Convert Images to TIFF Online',
    ...
    'bmp.openvibe.tools': {
        ...
        faIcon: 'fa-file-image',
        seoTitle: 'OpenVibeBMP — Convert Images to BMP Online',
        seoDescription: 'Convert images to and from BMP bitmap format online. Fast.',
    },
    ...
    'compress.openvibe.tools': {
        ...
        faIcon: 'fa-compress',
        seoTitle: 'OpenVibeCompress — Compress Images Online',
        seoDescription: 'Reduce image file size without losing quality. Compress PNG, JPG, WebP, AVIF images online.',
    },
    'resize.openvibe.tools': {
        toolId: 'resize', brandName: 'OpenVibeResize', defaultOp: 'resize',
        faIcon: 'fa-up-right-and-down-left-from-center',
        seoTitle: 'OpenVibeResize — Resize Images Online',
        seoDescription: 'Resize images to any dimension. Scale by pixels, percentage, or fit mode. Online image resizer.',
    },
    'crop.openvibe.tools': {
        toolId: 'crop', brandName: 'OpenVibeCrop', defaultOp: 'crop',
        faIcon: 'fa-crop-simple',
        seoTitle: 'OpenVibeCrop — Crop Images Online',
        seoDescription: 'Crop images by custom dimensions or preset aspect ratios (16:9, 4:3, 1:1). Online image cropper.',
    },
    'convert.openvibe.tools': {
        toolId: 'convert', brandName: 'OpenVibeConvert', defaultOp: 'convert',
        faIcon: 'fa-arrows-rotate',
        seoTitle: 'OpenVibeConvert — Convert Image Formats Online',
    ...
    'favicon.openvibe.tools': {
        ...
        faIcon: 'fa-icons',
        seoTitle: 'OpenVibeFavicon — Generate Favicons Online',
